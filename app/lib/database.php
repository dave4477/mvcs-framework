...
define("DB_HOST",	'localhost');		// MySQL Server ( mostly localhost).
define("DB_NAME",	'highscores');		// Name of the database.
define("DB_USER", 	'gameadmin');		// Name of a valid MySQL user
define("DB_PASS",	'not24get');		// Password of this valid MySQL user.
