...
class cleanPost
{
   ...
   */
  function post($arg, $fixlinks = FALSE, $defaultValue = "")
  {
    $var = (isset($_POST[$arg])) ? $_POST[$arg] : $defaultValue;
   ...
   */
  function get($arg, $fixlinks = FALSE, $defaultValue = "")
  {
    $var = (isset($_GET[$arg])) ? $_GET[$arg] : $defaultValue;
   ...
   */
  function request($arg, $fixlinks = FALSE, $defaultValue = "")
  {
    $var = (isset($_REQUEST[$arg])) ? $_REQUEST[$arg] : $defaultValue;
