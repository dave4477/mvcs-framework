...
export default class Character extends fw.core.viewCore {
    ...
    create(scene) {
        ...
        gltfloader.load("./assets/RobotExpressive.glb", (gltf) => {
            ...
            const parent = new THREE.Mesh( new THREE.CubeGeometry( 0.5, 1.7, 1 ), new THREE.MeshBasicMaterial({transparent:true, color:0x00FF00, opacity:0}) );
    ...
    handlePlayerCollision(targetObject, linearVelocity, angularVelocity) {
        ...
        switch (targetObject.name) {
            ...
            case "boat":
                ...
                targetObject.addEventListener('collision', this.handlePlayerCollision.bind(this));
                break;
